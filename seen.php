...
$seen = array_keys($_SESSION["isRead"],1);
$seenpost = array();
$i=0;
foreach ($seen as $key){
    $seenpost[$i++] = $posts[$key];
}
        ...
        <div style="padding-bottom: 5px;" >
            ...
            <div class="icerik col-md-10">
                ...
                <div class="islem pull-right" style="margin-right: 25px;">
                    ...
                    <a href="seen-delete.php?id=<?php echo $key['id']; ?>" class="detay btn btn-info" style=" color: red; background-color: white;">Okunanlardan Kaldır</a>
                </div>
            </div>
            <div><br>
                <?php endforeach; ?>
